...
* Multiple display styles including Pixel Perfect, Scaled, Bilinear, Blur, and Ultra Sharp.
...
```text
build-3ds/game/tmc-3ds-v1.2-E11.cia
build-3ds/game/tmc-3ds-v1.2-E11.3dsx
```
